    ...
    static class UserInterface
    {
        ...
        public static void DisplayInstructions()
        {
            Console.WriteLine("Welcome to Lemonade Stand!\n" +
                ...
                "Then choose your recipe and set the price for your lemonade.  Be careful not to charge too much as this will also affect how many customers you will have.\n" +
